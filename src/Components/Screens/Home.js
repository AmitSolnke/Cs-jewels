...
const dazzlingFev = [{img: prod1, name: "GOLD BANGLES" },{img: prod2, name: "LAYERED BRACELETS" },{img: prod3, name: "DIAMOND NECKLACE" },{img: prod4, name: "KUNDAN NECKLACE" }]
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={11} md={11}>
            <div className="image-slider-header">
              Dazzling Favorites
              {' '}
              <img className="img-right right-logo" src={imageSliderHeaderIconRight} alt="React Logo" />
            </div>
          </Grid>
          <Grid item xs={1} md={1}>
            <Item className="empty-container-section">xs=6 md=4</Item>
