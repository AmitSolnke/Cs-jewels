...
export default function ProductDetails() {
  ...
  const [product, setProduct] = useState({
    images: [
      {
        image_path:
          "http://13.127.176.195/CSJewels/public/uploads/1/Product/coin1.jpg",
        image_name: "coin3",
      },
      {
        image_path:
      ...
      <Grid className="product-details-main">
        ...
        <div className="product-info-container p-3" xs={12} md={5}>
          <div className="product-name-wrapper">
            <div className="product-name">{productDetails.product_name}</div>
            <div className="logo">
              <FavoriteBorderIcon />
              <ShareOutlinedIcon />
            </div>
          ...
          <div className="weight">
            {productDetails.purity} | {productDetails.gross_wt} GM
          </div>
            ...
            <div className="col-12 col-md-4">
              ...
              <div className="col-6 col-md-8">
                ...
                >
                  ...
                  <Typography className="quantity" variant="body1">
                    {quantity}
                  </Typography>
                  <IconButton
          ...
          <div className="shopping-btn-wrapper">
            ...
            <button
              ...
              onClick={() => navigate("/order/check-out")}
            >
