            ...
            <div className="contact-us-container">
                <div className='contact-us-center' >
                    ...
                    <div className='contact-us-description'>
                        Send an email to &nbsp;<div className='decoration-contact-us-underline'>custcare@csjewellers.com</div> &nbsp;or call us on &nbsp; <div className='decoration-contact-us-underline'> 07969991827 </div>&nbsp;anytime! We will get back to you as soon as we can!
                    </div>
                </div>
                <div className='contact-us-center'>
